...
from CIGT.encoder.graphormer_encoder import graphormer_pre_processing
...
def compute_posenc_stats(data, pe_types, is_undirected, cfg):
    ...
    for t in pe_types:
        if t not in ['LapPE', 'EquivStableLapPE', 'SignNet', 'RWSE', 'HKdiagSE',
                     'HKfullPE', 'ElstaticSE', 'GraphormerBias','convR']:
    ...
    # if 'convR' in pe_types:
    #     data = convR_pre_processing(data)
