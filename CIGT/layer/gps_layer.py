...
from CIGT.layer.bigbird_layer import SingleBigBirdLayer
from CIGT.layer.gatedgcn_layer import GatedGCNLayer
from CIGT.layer.gine_conv_layer import GINEConvESLapPE
from CIGT.layer.GatedGeoGcn import GatedGeoGCNLayer
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        elif local_gnn_type == 'GatedGeoGCN':
            self.local_model = GatedGeoGCNLayer(dim_h, dim_h,
                                             dropout=dropout,
                                             residual=True,
                                             act=act,
                                             equivstable_pe=equivstable_pe)
    ...
    def forward(self, batch):
        ...
        if self.local_model is not None:
            ...
            if self.local_gnn_type == 'CustomGatedGCN' or 'GatedGeoGcn':
                es_data = None
