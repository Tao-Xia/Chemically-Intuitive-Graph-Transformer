...
def feature_matrix(DATA, active_orbital, nae, nao, numl, vb_str = "FULL", ):
    Z, R, nel = read(DATA)
...
"""     
        ...
        print("active atom:",len(active_orbital))
        node_feat, edge_feat, adjacency, ac_orb, nel, nae = feature_matrix(molecule, active_orbital, nae, nao, numl, vb_str_space)
