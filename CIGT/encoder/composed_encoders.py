...
from CIGT.encoder.ast_encoder import ASTNodeEncoder
from CIGT.encoder.kernel_pos_encoder import RWSENodeEncoder, \
    HKdiagSENodeEncoder, ElstaticSENodeEncoder
from CIGT.encoder.laplace_pos_encoder import LapPENodeEncoder
from CIGT.encoder.ppa_encoder import PPANodeEncoder
from CIGT.encoder.signnet_pos_encoder import SignNetNodeEncoder
from CIGT.encoder.voc_superpixels_encoder import VOCNodeEncoder
from CIGT.encoder.type_dict_encoder import TypeDictNodeEncoder
from CIGT.encoder.linear_node_encoder import LinearNodeEncoder
from CIGT.encoder.equivstable_laplace_pos_encoder import EquivStableLapPENodeEncoder
from CIGT.encoder.graphormer_encoder import GraphormerEncoder
...
def concat_node_encoders(encoder_classes, pe_enc_names):
    ...
    class Concat3NodeEncoder(torch.nn.Module):
        ...
        def __init__(self, dim_emb):
            ...
            self.encoder3 = self.enc3_cls(dim_emb)
